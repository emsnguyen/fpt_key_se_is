...
5px 0 20px;background:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded) 2px center no-repeat}.jsenabled .mod-assign-history-link-closed{padding:0
5px 0 20px;background:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed) 2px center no-repeat}.dir-rtl.jsenabled .mod-assign-history-link-closed{padding:0
20px 0 5px;background:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl) 2px center no-repeat}#page-mod-assign-view
...
li.correct{color:green;list-style-image:url(/elearning/theme/image.php/essential/core/1486604992/i/tick_green_small)}#page-mod-hotpot-report ul.response
li.ignored{color:grey;list-style-image:url(/elearning/theme/image.php/essential/core/1486604992/i/show)}#page-mod-hotpot-report ul.response
li.wrong{color:red;list-style-image:url(/elearning/theme/image.php/essential/core/1486604992/i/cross_red_small)}#page-mod-hotpot-report ul.response
li.score{color:inherit;list-style-image:url(/elearning/theme/image.php/essential/core/1486604992/i/item)}#page-mod-hotpot-report ul.response
li.hintsclueschecks{color:#666;list-style-image:url(/elearning/theme/image.php/essential/core/1486604992/i/item)}#page-mod-hotpot-review
...
.trafficlight{background:url(/elearning/theme/image.php/essential/quiz/1486604992/navflagged) no-repeat top right}.path-mod-quiz .qnbutton.notyetanswered,
...
li{background-image:url(/elearning/theme/image.php/essential/mod_workshop/1486604992/userplan/task-todo);background-position:top left;background-repeat:no-repeat;list-style-type:none;min-height:16px;margin: .3em 0}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(/elearning/theme/image.php/essential/mod_workshop/1486604992/userplan/task-done)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(/elearning/theme/image.php/essential/mod_workshop/1486604992/userplan/task-fail)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(/elearning/theme/image.php/essential/mod_workshop/1486604992/userplan/task-info)}.path-mod-workshop .userplan tr.phasetasks
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(/elearning/theme/image.php/essential/core/1486604992/i/star-rating) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(/elearning/theme/image.php/essential/core/1486604992/i/star-rating) left bottom;position:absolute;height:20px;display:block;text-indent:-9000px;z-index:1}#page-blocks-community-communitycourse
...
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded);background-position:0 0;background-repeat:no-repeat}.block_navigation .block_tree
...
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty);background-position:0 0;background-repeat:no-repeat}.jsenabled .block_navigation .block_tree .collapsed
ul{display:none}.jsenabled .block_navigation .block_tree .type_activity>.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded)}.jsenabled .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed)}.jsenabled .block_navigation .block_tree
.tree_item.branch.loadingbranch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/i/loading_small)}.jsenabled .block_navigation.dock_on_load,
...
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty_rtl);background-position:center right}.jsenabled.dir-rtl .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl)}.block_online_users .content .list
...
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.root_node.leaf{padding-left:0px}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed)}.ie6 .block_settings .block_tree
...
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty_rtl);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl)}.block_site_main_menu
...
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_down)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-arrow
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_right)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-arrow
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_down)}#toggle-all .content .toggle-arrow h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_down)}#toggle-all .content .toggle-arrow-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_right_glow)}#toggle-all .content .toggle-arrow h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_right)}#toggle-all .content .toggle-arrow-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_down_glow)}.course-content ul.ctopics li.section .content .toggle-bulb a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-bulb
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-bulb
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-bulb
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_on)}#toggle-all .content .toggle-bulb h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_on)}#toggle-all .content .toggle-bulb-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_off_glow)}#toggle-all .content .toggle-bulb h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_off)}#toggle-all .content .toggle-bulb-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_on_glow)}.course-content ul.ctopics li.section .content .toggle-cloud a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-cloud
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-cloud
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-cloud
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_on)}#toggle-all .content .toggle-cloud h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_on)}#toggle-all .content .toggle-cloud-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_off_glow)}#toggle-all .content .toggle-cloud h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_off)}#toggle-all .content .toggle-cloud-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_on_glow)}.course-content ul.ctopics li.section .content .toggle-eye a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-eye
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_show)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-eye
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_hide)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-eye
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_show)}#toggle-all .content .toggle-eye h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_show)}#toggle-all .content .toggle-eye-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_hide_glow)}#toggle-all .content .toggle-eye h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_hide)}#toggle-all .content .toggle-eye-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_show_glow)}.course-content ul.ctopics li.section .content .toggle-led a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-led
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-led
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-led
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_on)}#toggle-all .content .toggle-led h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_on)}#toggle-all .content .toggle-led-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_off_glow)}#toggle-all .content .toggle-led h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_off)}#toggle-all .content .toggle-led-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_on_glow)}.course-content ul.ctopics li.section .content .toggle-point a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-point
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_down)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-point
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_right)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-point
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_down)}#toggle-all .content .toggle-point h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_down)}#toggle-all .content .toggle-point-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_right_glow)}#toggle-all .content .toggle-point h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_right)}#toggle-all .content .toggle-point-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_down_glow)}.course-content ul.ctopics li.section .content .toggle-power a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-power
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_plus)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-power
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_minus)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-power
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_plus)}#toggle-all .content .toggle-power h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_plus)}#toggle-all .content .toggle-power-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_minus_glow)}#toggle-all .content .toggle-power h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_minus)}#toggle-all .content .toggle-power-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_plus_glow)}.course-content ul.ctopics li.section .content .toggle-radio a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-radio
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-radio
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-radio
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_on)}#toggle-all .content .toggle-radio h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_on)}#toggle-all .content .toggle-radio-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_off_glow)}#toggle-all .content .toggle-radio h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_off)}#toggle-all .content .toggle-radio-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_on_glow)}.course-content ul.ctopics li.section .content .toggle-smiley a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-smiley
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-smiley
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-smiley
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_on)}#toggle-all .content .toggle-smiley h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_on)}#toggle-all .content .toggle-smiley-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_off_glow)}#toggle-all .content .toggle-smiley h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_off)}#toggle-all .content .toggle-smiley-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_on_glow)}.course-content ul.ctopics li.section .content .toggle-square a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-square
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-square
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-square
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_on)}#toggle-all .content .toggle-square h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_on)}#toggle-all .content .toggle-square-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_off_glow)}#toggle-all .content .toggle-square h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_off)}#toggle-all .content .toggle-square-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_on_glow)}.course-content ul.ctopics li.section .content .toggle-sunmoon a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-sunmoon
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-sunmoon
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-sunmoon
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_on)}#toggle-all .content .toggle-sunmoon h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_on)}#toggle-all .content .toggle-sunmoon-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_off_glow)}#toggle-all .content .toggle-sunmoon h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_off)}#toggle-all .content .toggle-sunmoon-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_on_glow)}.course-content ul.ctopics li.section .content .toggle-switch a.toggle_closed, .course-content ul.ctopics li.section .content .toggle-switch
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_on)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-switch
a.toggle_closed{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_off)}body.jsenabled .course-content ul.ctopics li.section .content .toggle-switch
a.toggle_open{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_on)}#toggle-all .content .toggle-switch h4
a.off{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_on)}#toggle-all .content .toggle-switch-hover h4 a.off:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_off_glow)}#toggle-all .content .toggle-switch h4
a.on{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_off)}#toggle-all .content .toggle-switch-hover h4 a.on:hover{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_on_glow)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="arrow"], body.format-topcoll select#id_toggleiconset option[value="arrow"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/arrow_right)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="bulb"], body.format-topcoll select#id_toggleiconset option[value="bulb"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/bulb_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="cloud"], body.format-topcoll select#id_toggleiconset option[value="cloud"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/cloud_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="eye"], body.format-topcoll select#id_toggleiconset option[value="eye"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/eye_hide)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="led"], body.format-topcoll select#id_toggleiconset option[value="led"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/led_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="point"], body.format-topcoll select#id_toggleiconset option[value="point"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/point_right)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="power"], body.format-topcoll select#id_toggleiconset option[value="power"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/toggle_minus)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="radio"], body.format-topcoll select#id_toggleiconset option[value="radio"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/radio_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="smiley"], body.format-topcoll select#id_toggleiconset option[value="smiley"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/smiley_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="square"], body.format-topcoll select#id_toggleiconset option[value="square"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/square_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="sunmoon"], body.format-topcoll select#id_toggleiconset option[value="sunmoon"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/sunmoon_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option[value="switch"], body.format-topcoll select#id_toggleiconset option[value="switch"]{background-image:url(/elearning/theme/image.php/essential/format_topcoll/1486604992/switch_off)}body#page-admin-setting-formatsettingtopcoll select#id_s_format_topcoll_defaulttoggleiconset option, body.format-topcoll select#id_toggleiconset
...
input{width:20px;height:15px;background:transparent url("/elearning/theme/image.php/essential/core/1486604992/t/delete") no-repeat center top;margin-top:4px}.gradingform_btec.editor .moveup
input{width:20px;height:15px;background:transparent url("/elearning/theme/image.php/essential/core/1486604992/t/up") no-repeat center top;margin-top:4px}.gradingform_btec.editor .movedown
input{width:20px;height:15px;background:transparent url("/elearning/theme/image.php/essential/core/1486604992/t/down") no-repeat center top;margin-top:4px}.gradingform_btec.editor .addcriterion input,
.gradingform_btec.editor .addcomment
input{background:transparent url("/elearning/theme/image.php/essential/core/1486604992/t/addgreen") no-repeat;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_btec.editor .addcriterion input,
.gradingform_btec.editor .addcomment
...
.markingbteccomment{cursor:pointer}.jsenabled .gradingform_btec .markingbteccomment:before{content:url("/elearning/theme/image.php/essential/core/1486604992/t/add");padding-right:2px}.gradingform_btec
...
input{width:20px;height:16px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/delete) no-repeat center top;margin-top:4px}.gradingform_guide.editor .moveup
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/up) no-repeat center top;margin-top:4px}.gradingform_guide.editor .movedown
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/down) no-repeat center top;margin-top:4px}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
input{background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/add) no-repeat;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
...
.markingguidecomment{cursor:pointer}.jsenabled .gradingform_guide .markingguidecomment:before{content:url(/elearning/theme/image.php/essential/core/1486604992/t/add);padding-right:2px}.gradingform_guide
...
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/delete) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .levels .level .delete
input{width:12px;height:16px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/delete) no-repeat center center}.dir-rtl .gradingform_rubric.editor .levels .level .delete
input{margin-right: .45em;margin-left:0}.gradingform_rubric.editor .moveup
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/up) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .movedown
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/down) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel
input{background:transparent url(/elearning/theme/image.php/essential/core/1486604992/t/add) no-repeat top left;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_rubric.editor .addcriterion
...
.smartselect_submenuitem{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed);background-position:100%;background-repeat:no-repeat}.smartselect.spanningmenu
...
.ajaxworking{width:16px;height:16px;background:url(/elearning/theme/image.php/essential/core/1486604992/i/ajaxloader) no-repeat}.dir-rtl.path-course-view li.activity form.togglecompletion,.dir-rtl.path-course-view li.activity
...
a{display:block;padding-left:21px;background-image:url(/elearning/theme/image.php/essential/core/1486604992/i/course);background-position:center left;background-repeat:no-repeat}.coursebox.remotehost>.info>.name
a{background-image:url(/elearning/theme/image.php/essential/core/1486604992/i/mnethost)}.coursebox>.info>.name,.coursebox .content .teachers,.coursebox .content .courseimage,.coursebox .content
...
.name{padding:2px
18px;margin:3px;background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty);background-position:center left;background-repeat:no-repeat}.dir-rtl .course_category_tree .category>.info
.name{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_empty_rtl);background-position:center right}.course_category_tree .category.with_children>.info
.name{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded)}.course_category_tree .category.with_children.collapsed>.info
.name{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed)}.dir-rtl .course_category_tree .category.with_children.collapsed>.info
.name{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl)}.course_category_tree .category.collapsed>.content{display:none}.course_category_tree .category>.info{min-height:20px;min-height:0;padding:19px;padding:0;margin:3px
...
6px 1px 20px;background:#fff url('/elearning/theme/image.php/essential/core/1486604992/a/search') no-repeat 3px 3px;border:1px
solid #bbb}.fp-viewbar{float:right;width:69px;height:22px;margin-right:8px}.dir-rtl .fp-toolbar
img{vertical-align:-35%}.dir-rtl .fp-viewbar{float:left;width:100px}.fp-vb-icons{display:inline-block;*display:inline;width:22px;height:22px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_active') no-repeat 0 0;*zoom:1}.dir-rtl .fp-vb-icons{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_active') no-repeat 0 0}.fp-vb-icons.checked{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_selected')}.dir-rtl .fp-vb-icons.checked{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_selected')}.fp-viewbar.disabled .fp-vb-icons{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_inactive')}.fp-vb-details{display:inline-block;*display:inline;width:23px;height:22px;margin-left:-4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_list_active') no-repeat 0 0;*zoom:1}.dir-rtl .fp-vb-details{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_list_active') no-repeat 0 0}.fp-vb-details.checked{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_list_selected')}.dir-rtl .fp-vb-details.checked{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_list_selected')}.fp-viewbar.disabled .fp-vb-details{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_list_inactive')}.fp-vb-tree{display:inline-block;*display:inline;width:23px;height:22px;margin-left:-4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_tree_active') no-repeat 0 0;*zoom:1}.dir-rtl .fp-vb-tree{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_tree_active') no-repeat 0 0}.fp-vb-tree.checked{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_tree_selected')}.dir-rtl .fp-vb-tree.checked{display:block;float:left;margin-right:4px;background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_tree_selected')}.fp-viewbar.disabled .fp-vb-tree{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_tree_inactive')}.file-picker .fp-clear-left{clear:left}.dir-rtl .filemanager-toolbar .fp-vb-icons a:hover{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_selected')}.dir-rtl .filemanager-toolbar .fp-vb-icons.checked a:hover{background:url('/elearning/theme/image.php/essential/theme/1486604992/fp/view_icon_active') no-repeat 0 0}.dir-rtl .fp-vb-details a:hover{background:0;border:20px
...
.ygtvtn{width:17px;height:22px;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tn') 0 0 no-repeat}.dir-rtl .filemanager .ygtvtn,.dir-rtl .file-picker
.ygtvtn{width:17px;height:22px;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tn_rtl') 0 0 no-repeat}.file-picker .ygtvtm,.filemanager
.ygtvtm{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tm') 0 10px no-repeat}.file-picker .ygtvtmh,.filemanager
.ygtvtmh{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tm') 0 10px no-repeat}.file-picker .ygtvtp,.filemanager
.ygtvtp{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvtp,.dir-rtl .filemanager
.ygtvtp{background:url('/elearning/theme/image.php/essential/core/1486604992/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvtph,.filemanager
.ygtvtph{width:13px;height:22px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/tp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvtph,.dir-rtl .filemanager
.ygtvtph{background:url('/elearning/theme/image.php/essential/core/1486604992/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvln,.filemanager
.ygtvln{width:17px;height:22px;background:url('/elearning/theme/image.php/essential/core/1486604992/y/ln') 0 0 no-repeat}.dir-rtl .file-picker .ygtvln,.dir-rtl .filemanager
.ygtvln{background:url('/elearning/theme/image.php/essential/core/1486604992/y/ln_rtl') 0 0 no-repeat}.file-picker .ygtvlm,.filemanager
.ygtvlm{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/lm') 0 10px no-repeat}.file-picker .ygtvlmh,.filemanager
.ygtvlmh{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/lm') 0 10px no-repeat}.file-picker .ygtvlp,.filemanager
.ygtvlp{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/lp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvlp,.dir-rtl .filemanager
.ygtvlp{background:url('/elearning/theme/image.php/essential/core/1486604992/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvlph,.filemanager
.ygtvlph{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/essential/core/1486604992/y/lp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvlph,.dir-rtl .filemanager
.ygtvlph{background:url('/elearning/theme/image.php/essential/core/1486604992/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvloading,.filemanager
.ygtvloading{width:16px;height:22px;background:transparent url('/elearning/theme/image.php/essential/core/1486604992/y/loading') 0 0 no-repeat}.file-picker .ygtvdepthcell,.filemanager
.ygtvdepthcell{width:17px;height:32px;background:url('/elearning/theme/image.php/essential/core/1486604992/y/vline') 0 0 no-repeat}.file-picker .ygtvblankdepthcell,.filemanager
...
a.fheader{padding:0
5px 0 20px;margin-left:-20px;background:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded) 2px center no-repeat}.dir-rtl .mform fieldset.collapsible legend
a.fheader{padding:0
20px 0 5px;margin-right:-20px;margin-left:0;background-position:right center}.mform fieldset.collapsed legend
a.fheader{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed)}.dir-rtl .mform fieldset.collapsed legend
a.fheader{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl)}.jsenabled .mform .collapsed
...
.collapseexpand{padding-left:20px;background:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed) 2px center no-repeat}.dir-rtl .mform .collapsible-actions
.collapseexpand{padding-right:20px;padding-left:0;background:url(/elearning/theme/image.php/essential/core/1486604992/t/collapsed_rtl) right center no-repeat}.mform .collapsible-actions .collapse-all,.dir-rtl .mform .collapsible-actions .collapse-all{background-image:url(/elearning/theme/image.php/essential/core/1486604992/t/expanded)}.mform .fitem .fitemtitle
...
li.section.main{border-bottom:0px none;background:url(/elearning/theme/image.php/essential/theme/1486604992/bg/dot) bottom repeat-x}.course-content ul.topics
li.section.main.clearfix.current{box-shadow:0px 0px 10px #30add1;border-radius:5px}h2.pagetitle{padding:0px;margin:0px;font-size:1.2em;line-height:35px;color:#777;background:url(/elearning/theme/image.php/essential/theme/1486604992/bg/dot) left center repeat-x;background-size:4px 20px}h2.pagetitle
span{background:white url(http://cms.fpt.edu.vn/elearning/theme/image.php/essential/theme/1486604992/bg/body) repeat;padding-right:8px}.firstword{color: #30add1 !important;margin-right:-5px}.left.side{display:none}.editing
...
auto;background:#eee url(/elearning/theme/image.php/essential/theme/1486604992/bg/header) repeat;border-radius:250px;border:5px
...
i{font-size:40px;width:40px;margin-bottom:12px;color: #30add1}.marketing-image1{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/marketing1image/1486604992/Logo.gif) no-repeat}.marketing-image2{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/marketing2image/1486604992/logo%20%281%29.png) no-repeat}.marketing-image3{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/marketing3image/1486604992/images.jpg) no-repeat}.marketing-image1,.marketing-image2,.marketing-image3{background-size:contain;background-position:center top;width:100%;height: 100px;margin-bottom:5px}.myprofileitem.picture{width:100px;height:100px;margin:10px
auto;background:#eee url(/elearning/theme/image.php/essential/theme/1486604992/bg/header) repeat;border-radius:250px;border:5px
...
auto;margin-bottom:20px;overflow:hidden;background:transparent url(/elearning/theme/image.php/essential/theme/1486604992/bg/header) repeat 0% 0%;border:1px
...
p{width:45%;top:105px;color:#888;font-size:15px;line-height:26px;height:80px;overflow:hidden;font-family:"PT Sans",Arial,Helvetica,sans-serif;font-weight:400;font-style:italic}.da-slide .da-img{text-align:center;width:30%;top:0px;height:230px;line-height:320px;left:110%}.da-slide .da-img1{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/slide1image/1486604992/images%20%284%29.png) no-repeat 0 0}.da-slide .da-img2{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/slide2image/1486604992/images%20%283%29.png) no-repeat 0 0}.da-slide .da-img3{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/slide3image/1486604992/images%20%282%29.png) no-repeat 0 0}.da-slide .da-img4{background:url(//cms.fpt.edu.vn/elearning/pluginfile.php/1/theme_essential/slide4image/1486604992/images.jpeg) no-repeat 0 0}.da-slide .da-link{top:200px;border-radius:15px;box-shadow:0px 1px 1px rgba(0,0,0,0.1);color:#fff;text-shadow:1px 1px 1px rgba(0,0,0,0.2);padding:3px
