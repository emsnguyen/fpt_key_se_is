...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(http://cms.fpt.edu.vn/elearning/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(http://cms.fpt.edu.vn/elearning/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
    background-color: red;
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(http://cms.fpt.edu.vn/elearning/mod/lesson/token.gif);
...
.ygtvtn { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/tn.gif) 0 0 no-repeat; width:17px; height:22px; }

/* first or middle sibling, collapsable */
.ygtvtm { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/tm.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* first or middle sibling, collapsable, hover */
.ygtvtmh { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/tmh.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* first or middle sibling, expandable */
.ygtvtp { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/tp.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* first or middle sibling, expandable, hover */
.ygtvtph { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/tph.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* last sibling, no children */
.ygtvln { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/ln.gif) 0 0 no-repeat; width:17px; height:22px; }

/* Last sibling, collapsable */
.ygtvlm { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/lm.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* Last sibling, collapsable, hover */
.ygtvlmh { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/lmh.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* Last sibling, expandable */
.ygtvlp { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/lp.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* Last sibling, expandable, hover */
.ygtvlph { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/lph.gif) 0 0 no-repeat; width:34px; height:22px; cursor:pointer }

/* Loading icon */
.ygtvloading { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/loading.gif) 0 0 no-repeat; width:16px; height:22px; }

/* the style for the empty cells that are used for rendering the depth 
 * of the node */
.ygtvdepthcell { background: url(http://cms.fpt.edu.vn/elearning/blocks/course_menu/icons/tree/vline.gif) 0 0 no-repeat; width:17px; height:22px; }
...
.yui-skin-sam .yui-panel .hd{padding:0 10px;font-size:93%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;background:url(http://cms.fpt.edu.vn/elearning/lib/yui/assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .container-close{border-color: #45c;position:absolute;top:5px;right:6px;width:25px;height:15px;background:url(http://cms.fpt.edu.vn/elearning/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}
.yui-skin-sam .yui-simple-dialog .bd .yui-icon{background:url(http://cms.fpt.edu.vn/elearning/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 0;width:16px;height:16px;margin-right:10px;float:left;}
